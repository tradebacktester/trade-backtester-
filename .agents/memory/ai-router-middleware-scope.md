...
**How to apply:**
Any time you add `router.use(middleware)` to a sub-router in this codebase, give it the path prefix matching that router's routes (e.g. `"/ai"`, `"/strategies"`, `"/backtests"`).
