      ...
      >
        ...
        <div className="px-6 pt-5 pb-6 flex flex-col gap-3">
          ...
          <button
            ...
            style={{
              border: agreed ? "1px solid hsl(var(--ring))" : "1px solid hsl(var(--border))",
              background: agreed ? "hsl(var(--muted))" : "hsl(var(--muted))",
            ...
            onMouseLeave={e => { if (agreed) e.currentTarget.style.borderColor = "hsl(var(--ring))"; else e.currentTarget.style.borderColor = "hsl(var(--border))"; }}
          >
          ...
          <button
            ...
            onMouseLeave={e => { if (agreed) e.currentTarget.style.borderColor = "hsl(var(--ring))"; else e.currentTarget.style.borderColor = "hsl(var(--border))"; }}
          >
            <svg viewBox="0 0 24 24" style={{ height: "16px", width: "16px", flexShrink: 0 }} fill="currentColor">
